...
from pointmvsnet.lightningmodel import PointMVSNetPLModel
from mv3d.dsets import frameselector

pointmvsnet = PointMVSNetPLModel(config.FINETUNE_LR, config.FINETUNE_LR_STEP, config.FINETUNE_LR_GAMMA)
pointmvsnet.load_pretrained_pointmvsnet()
...
trainer.fit(pointmvsnet, loader, val_loader)

...
from pointmvsnet.utils.io import write_cam_dtu, write_pfm


def eval_file_logger(data_batch, preds, scene_folder, out_index):
    ...
    # print(l, eval_folder, scene, scene_folder)
    # exit()
    ...
    ref_image = data_batch["ref_img"][0].permute(1, 2, 0).cpu().numpy()

...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_folder', type=str,
                        default='/home/alex/Desktop/pmvs_tmp/')
    parser.add_argument('--fusibile_exe_path', type=str, default='/home/alex/Desktop/cloned_paper_code/mvsnet-fusibile/build/fusibile')
    ...
    parser.add_argument("-f", '--depth_folder', type=str, default='depth')
